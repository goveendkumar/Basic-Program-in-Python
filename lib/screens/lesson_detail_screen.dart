...
class _LessonDetailScreenState extends State<LessonDetailScreen> {
  // Simple Quiz and Flashcards mini states inside lesson
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [Colors.orange.shade300, Colors.deepOrange.shade100],
                        ),
                      ),
                      child: Center(
                        child: Column(
              ...
              // 3. Short Introduction & Explanation Toggle
              Text(
                isEnglish ? lesson.englishContent : lesson.romanEnglishContent,
                style: TextStyle(
                  fontSize: fontSize,
              ...
              // 4. Roman English Block if main language is English (helps learning the natural pronunciations)
              if (isEnglish) ...[
                Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
              ...
              if (lesson.sources.isNotEmpty) ...[
                ...
                Padding(
                  ...
                  child: Text(
                    lesson.sources.join(', '),
                    style: TextStyle(fontSize: fontSize - 2, fontStyle: FontStyle.italic, color: Colors.orange.shade800),
                  ),
                ),
                const SizedBox(height: 16),
              ],
              ...
              const Divider(thickness: 1.5, color: Colors.orange),
              const SizedBox(height: 12),
  ...
  Widget _buildMiniQuiz(BuildContext context, bool isDark, double fontSize, AppState state) {
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isDark ? Colors.grey.shade800 : Colors.orange.shade50.withOpacity(0.4),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(q.question, style: TextStyle(fontSize: fontSize, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          ...
          if (!_quizSubmitted)
            ElevatedButton(
              onPressed: _selectedQuizAnswerIdx == null
                  ? null
                  : () {
                      final chosen = q.options[_selectedQuizAnswerIdx!];
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        _flashcardFlipped ? fc.back : fc.front,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: fontSize + 1,
                          fontWeight: FontWeight.bold,
                          color: _flashcardFlipped ? Colors.black87 : Colors.orange.shade800,
                        ),
                      ),
                    ],
                  ),
